...
function getNearestCodeText(start: HTMLElement | null): string {
  ...
  while (el) {
    const code = el.querySelector?.("pre code, code, pre") as HTMLElement | null;
    if (code?.innerText) {
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <path d="M12 0C12 0 12 6.268 8.134 10.134C4.268 14 0 14 0 14C0 14 4.268 14 8.134 17.866C12 21.732 12 28 12 28C12 28 12 21.732 15.866 17.866C19.732 14 24 14 24 14C24 14 19.732 14 15.866 10.134C12 6.268 12 0 12 0Z" transform="scale(0.857) translate(0, -2)" />
      </svg>
    ),
    url: (code, lang) => {
      const prompt = `Explain this${lang ? ` ${lang}` : ""} code:\n\n\`\`\`${lang}\n${code}\n\`\`\``;
